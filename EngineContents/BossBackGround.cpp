...
ABossBackGround::ABossBackGround()
{
	...
	BG_Sky_Renderer->SetRelativeLocation({ 0.0f, -1000.0f, static_cast<float>(ERenderOrder::BACKGROUND)-1 });
	BG_Cloud1_Renderer->SetRelativeLocation({ 0.0f, 0.0f, static_cast<float>(ERenderOrder::BACKGROUND)-2 });
